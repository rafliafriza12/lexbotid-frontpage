          ...
          <div className="container px-4 md:px-6 py-12 md:py-24 max-w-5xl mx-auto">
            <div className="text-center mb-10 space-y-4">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                Asisten{" "}
                <span className="text-red-600 dark:text-red-400 inline-block animate-pulse">
                  Hukum
                </span>
              </h1>
              <p className="max-w-[700px] mx-auto text-gray-500 md:text-xl dark:text-gray-400">
                Diskusikan pertanyaan hukum Anda dengan asisten AI kami yang
                didukung oleh database perundang-undangan Indonesia terlengkap
              </p>
            </div>
            <ChatInterface />
          </div>
